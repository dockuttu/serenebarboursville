# -*- coding: utf-8 -*-
# build_rewards.py — /xperience-rewards/ : Merz Aesthetics Xperience+ loyalty page (Barboursville)
import json, os
ns={}
exec(open("common.py",encoding="utf-8").read(), ns)
LOGO=ns["LOGO"]; BOOK=ns["BOOK"]; NAV=ns["NAV"]; FOOTER=ns["FOOTER"]; SCRIPTS=ns["SCRIPTS"]
CONSULT=ns["CONSULT_SECTION"]; STICKY=ns.get("STICKY_BAR","")
SITE="https://barboursville.serenemedspas.com"; URL=SITE+"/xperience-rewards/"
...
FAQ=[
 ...
 ("Can I use points at both Serene locations?","Yes. Xperience+ is tied to you, not the clinic, so points earned in Barboursville can be used at our Hudson, Ohio location and vice versa."),
...
def clean(s): return s.replace("&rsquo;","'").replace("&ndash;","–")
...
faq_schema={"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":clean(q),"acceptedAnswer":{"@type":"Answer","text":clean(a)}} for q,a in FAQ]}
...
<title>Xperience+ Rewards | Serene Med Spa Barboursville, WV</title>
<meta name="description" content="Earn Xperience+ points on Xeomin, Radiesse, Belotero &amp; Ultherapy PRIME at Serene Med Spa in Barboursville, WV — a Merz Aesthetics Bronze Preferred Partner. 100 points = $10 off.">
...
<meta property="og:type" content="website"><meta property="og:title" content="Xperience+ Rewards at Serene Med Spa Barboursville"><meta property="og:description" content="Earn points on Xeomin, Radiesse, Belotero &amp; Ultherapy PRIME. Every 100 points = $10 off."><meta property="og:url" content="{URL}"><meta property="og:image" content="{SITE}/img/badges/xperience-plus.png">
...
<section class="svc-hero">
  <div class="wrap">
    ...
    <div class="svc-hero-txt" style="max-width:760px">
      ...
      <div class="eyebrow">Merz Aesthetics Loyalty &middot; Barboursville, WV</div>
...
<section class="tint-blush">
  <div class="wrap">
    <div class="ult-cred reveal">
      ...
      <p>Serene Med Spa is a <strong>Merz Aesthetics Bronze Preferred Partner</strong> and an authorized <strong><a href="/ultherapy/">Ultherapy PRIME</a></strong> provider in Barboursville, West Virginia.</p>
    </div>
  </div>
</section>
...
print("build_rewards: wrote xperience-rewards/index.html (%d bytes)"%len(HTML))
