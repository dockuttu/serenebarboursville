...
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Offer","name":"Studio 3 special: 30% off Ultherapy PRIME","description":"First 20 clients who book Ultherapy after the WSAZ Studio 3 segment save 30% at Serene Med Spa (Barboursville, WV or Hudson, OH). Mention Studio 3 when booking.","url":"{URL}#studio3","validFrom":"2026-09-18","validThrough":"2026-10-31","category":"Promotion","areaServed":"Barboursville, WV","offeredBy":{{"@type":"MedicalBusiness","name":"Serene Med Spa — Barboursville","url":"{URL}"}}}}</script>
<script type="application/ld+json">
...
<section id="studio3" class="tint-sand"><div class="wrap">
  ...
  <div class="card reveal studio3-offer"><div class="ico">&#10022;</div><h3>Studio 3 special: 30% off Ultherapy</h3>
    <p>The first 20 clients who book Ultherapy after the segment save <strong>30%</strong> on any Ultherapy PRIME treatment at either Serene office &mdash; Barboursville or Hudson. Mention <strong>&ldquo;Studio 3&rdquo;</strong> when you book. Offer ends <strong>October 31, 2026</strong>; can&rsquo;t be combined with other discounts.</p>
    <p><a class="btn" href="{BOOK}">Book a Consultation</a> <a class="btn btn-outline" href="#pricing">See Ultherapy pricing</a></p></div>
  <style>
