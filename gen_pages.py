...
DEVICE_LOGOS = {"harmony-bio-boost":["harmony-bio-boost"],"alma-hybrid":["alma-hybrid"],"laser-hair-removal":["soprano-ice-platinum"],"opus-plasma":["opus-plasma"],"alma-ted":["alma-ted"],"alma-duo":["alma-duo"],"botox":["botox-cosmetic","app-platinum"],"fillers":["juvederm","app-platinum"],"lip-filler":["juvederm","app-platinum"],"cheek-filler":["juvederm","app-platinum"],"under-eye-filler":["juvederm","app-platinum"],"jawline-filler":["juvederm","app-platinum"],"chin-filler":["juvederm","app-platinum"],"skinvive":["skinvive","app-platinum"],"kybella":["kybella","app-platinum"],"sknlab":["sknlab"]}  # slug -> Alma logo keys shown as a "Powered by" badge under the hero
exec(open("journal_block.py").read())  # "From the Journal" cross-links (journal_posts.py is generated by the blog build)
SITE_LOC = "barboursville"  # Fitzpatrick skin-type quiz (QUIZ_SLUGS, quiz_for)  # LOGO, BOOK, book_for, NAV, FOOTER, SCRIPTS, areas_section, AREA_SERVED
...
IMG = {
 ...
 "sknlab":"/img/sknlab-card.jpg",
 "hydrafacial":"/img/hydrafacial.jpg",
 "medical-facials":"/img/facial-2.jpg",
}
RELATED_META = {
 ...
 "sknlab":("SKNLAB Facial","Six-handpiece energy + hydration facial."),
 "hydrafacial":("HydraFacial","Cleanse, exfoliate, extract, hydrate."),
 "medical-facials":("Medical Facials","Classic, acne, enzyme and dermaplane facials."),
}
...
def build_page(p):
    ...
    return TEMPLATE.format(
        ...
        stats=STATS_BRANDS,pmatch=(PRICE_MATCH_BAND if p["slug"] in PM_SLUGS else ""),reviews=REVIEWS_SECTION,journal=journal_section(p["slug"],SITE_LOC),results=RESULTS_SECTION,finance=FINANCE_BAND,sticky=STICKY_BAR,
