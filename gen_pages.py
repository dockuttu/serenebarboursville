...
DEVICE_LOGOS = {"harmony-bio-boost":["harmony-bio-boost"],"alma-hybrid":["alma-hybrid"],"laser-hair-removal":["soprano-ice-platinum"],"opus-plasma":["opus-plasma"],"alma-ted":["alma-ted"],"alma-duo":["alma-duo"],"sknlab":["sknlab"]}  # slug -> Alma logo keys shown as a "Powered by" badge under the hero
