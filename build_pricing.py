...
URL="https://barboursville.serenemedspas.com/pricing/"
...
CATS.append(("Longevity &amp; NAD+",
  row("Niagen&reg; IV &mdash; 500mg","$499")+row("Niagen&reg; IV &mdash; 250mg","$299")+
  ...
  sub("Monthly Programs")+row("Longevity Consultation","$99")+row("Sermorelin &mdash; Injectable (Rx)","$199","/mo")+row("Sermorelin &mdash; Tablets (Rx)","$249","/mo")+row("NAD+ &amp; Sermorelin (Rx)","$279","/mo")+row("Low-Dose Naltrexone (Rx)","$59","/mo")+
...
CATS.append(("Hair, Face &amp; Body", sub("Hair Restoration")+
  row("PRP Hair Restoration","$500","/tx")+row("PRP Hair Restoration &mdash; series of 3, prepaid","$1,200")+row("Alma TED","$500","/tx")+row("Alma TED &mdash; series of 3, prepaid","$1,200")+
...
OFFERS=[("Botox",10),("Dermal Fillers",500),("Lip Filler - Full Syringe (1 mL)",500),("Lip Filler - Half Syringe (0.5 mL)",300),("Sculptra",600),("Kybella",600),("PDO Thread Lift",300),("Kenalog Injection",75),
 ...
 ("Laser Hair Removal",49),("Laser Tattoo Removal",125),("EvolveX",250),("IV Vitamin Infusion",149),("Niagen IV 500mg",499),("NAD+ IV 500mg",299),
...
<meta property="og:title" content="Menu &amp; Pricing &mdash; Serene Med Spa, Barboursville WV">
<meta property="og:description" content="Physician-led med spa pricing in Barboursville, West Virginia &mdash; injectables, laser, body, wellness &amp; more.">
...
<section class="svc-hero">
  <div class="wrap">
    ...
    <div class="svc-hero-grid">
      ...
      <div class="svc-hero-media"><img src="/img/facial-2.jpg" alt="Serene Med Spa treatment menu &amp; pricing, Barboursville West Virginia" width="800" height="800"></div>
    </div>
  </div>
</section>
